...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'products',   name: 'products',  component: () => import('@/pages/Products/Index.vue'), meta: { permission: 'inventory.manage' } },
            { path: 'orders',     name: 'orders',    component: () => import('@/pages/Orders/Index.vue'),   meta: { permission: 'inventory.manage' } },
